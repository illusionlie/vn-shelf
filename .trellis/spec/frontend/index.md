...
|-------|-------------|--------|
| [Directory Structure](./directory-structure.md) | Module organization and file layout | Filled (B1: vendor layout; B5b: i18n.js + locales/; project structure) |
...
| [Quality Guidelines](./quality-guidelines.md) | Code standards, forbidden patterns, a11y | Filled (B1/B3/B4: vendor self-host, header merge, Date.now id, native confirm, modal role/Esc, keyboard div, friendlyError layering, code-review checklist; B5b: i18n t() contract + backend-message boundary) |
